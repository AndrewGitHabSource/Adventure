<form action="#" method="post" id="form-filter">
    <div class="fields">
        ...
        <div class="form-group">
            <input value="@if (request()->start_date) {{ request()->start_date }} @endif" name="start_date" type="text" id="checkin_date" class="form-control checkin_date" placeholder="Date from">
        </div>

        <div class="form-group">
            <input value="@if (request()->end_date) {{ request()->end_date }} @endif" name="end_date" type="text" id="checkout_date" class="form-control checkout_date" placeholder="Date to">
        </div>
        ...
        <div class="form-group">
            <div class="range-slider">
                ...
                <input class="price_start" name="price_start" min="0" max="100" step="1" value="@if (request()->price_start){{request()->price_start}}@else{{0}}@endif" type="range"/>

                <input class="price_end" name="price_end" min="0" max="100" step="1" value="@if (request()->price_end){{ request()->price_end }}@else{{20}}@endif" type="range"/>
            </div>
        </div>
