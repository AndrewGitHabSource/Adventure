        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div>
                            <a href="{{ route('hotels.rooms.create', ['hotel' => request()->hotel]) }}">Add Room</a>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <div class="input-group input-group-sm" style="width: 280px;">
                                        <form id="search-form" name="form" method="get" action="{{ route('hotels.rooms.index', ['hotel' => request()->hotel]) }}" style="width: 100%; display: flex;">
                            ...
                            <div class="card-body table-responsive p-0 search-ajax">
                                @include('admin.room.rooms_loop', ['rooms' => $rooms])
                            </div>
                        </div>
                    </div>
                </div>
