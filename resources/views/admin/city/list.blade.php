                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">List Cities</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <div class="input-group input-group-sm" style="width: 280px;">
                                        <form id="search-form" name="form" method="get" action="{{ route('cities.index') }}" style="width: 100%; display: flex;">
                            ...
                            <div class="card-body table-responsive p-0 search-ajax">
                                @include('admin.city.cities_loop', ['cities' => $cities])
                            </div>
                        </div>
                    </div>
                </div>
