                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <div class="input-group input-group-sm" style="width: 280px;">
                                        <form id="search-form" name="form" method="get" action="{{ route('categories.index') }}" style="width: 100%; display: flex;">
                            ...
                            <div class="card-body table-responsive p-0 search-ajax">
                                @include('admin.category.categories_loop', ['categories' => $categories])
                            </div>
                        </div>
                    </div>
                </div>
