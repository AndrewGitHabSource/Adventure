                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <div class="input-group input-group-sm" style="width: 280px;">
                                        <form id="search-form" name="form" method="get" action="{{ route('subscribers.index') }}" style="width: 100%; display: flex;">
                            ...
                            <div class="card-body table-responsive p-0 search-ajax">
                                @include('admin.subscriber.subscribers_loop', ['subscribers' => $subscribers])
                            </div>
                        </div>
                    </div>
                </div>
